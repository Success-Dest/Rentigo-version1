...
<div class="page-content">
    ...
    <div class="page-header">
        ...
        <div class="header-actions">
            <a href="<?php echo URLROOT; ?>/admin/addProvider" class="btn btn-primary">
    ...
    <div class="search-filter-section">
        <form method="GET" action="<?php echo URLROOT; ?>/admin/providers">
            <div class="search-filter-content">
                ...
                <div class="filter-dropdown-wrapper">
                    <select class="form-select" name="specialty">
                        ...
                        <option value="security" <?php echo ($data['specialty_filter'] ?? '') === 'security' ? 'selected' : ''; ?>>Security</option>
                        <option value="pest_control" <?php echo ($data['specialty_filter'] ?? '') === 'pest_control' ? 'selected' : ''; ?>>Pest Control</option>
                        <option value="general_maintenance" <?php echo ($data['specialty_filter'] ?? '') === 'general_maintenance' ? 'selected' : ''; ?>>General Maintenance</option>
                    </select>
                </div>
                <div class="filter-dropdown-wrapper">
                ...
                <a href="<?php echo URLROOT; ?>/admin/providers" class="btn btn-outline">
                            ...
                            <tr data-provider-id="<?php echo $provider->id; ?>">
                                ...
                                <td>
                                    <div class="provider-actions">
                                        <a href="<?php echo URLROOT; ?>/admin/editProvider/<?php echo $provider->id; ?>"
...
<script>
    ...
    function toggleProviderStatus(providerId, currentStatus) {
        ...
        if (confirmation) {
            fetch(`<?php echo URLROOT; ?>/admin/updateProviderStatus/${providerId}`, {
                    method: 'POST',
                    headers: {
    ...
    function deleteProvider(providerId) {
        ...
        if (confirmation) {
            fetch(`<?php echo URLROOT; ?>/admin/deleteProvider/${providerId}`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/x-www-form-urlencoded',
                    }
